...
3. Download and install the [Amazon DynamoDB JDBC Driver from CData](https://www.cdata.com/drivers/dynamodb/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
